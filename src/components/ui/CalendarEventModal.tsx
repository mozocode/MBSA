    ...
    >
      ...
      >
        ...
        <div className="p-6 md:p-8 border-b border-[#CFCFDA]">
          <h3 id="calendar-event-title" className="font-display font-bold text-xl md:text-2xl text-navy uppercase pr-10">
            {event.title}
          </h3>
