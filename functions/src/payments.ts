...
import { getAuthorizeServerConfig, isAuthorizeSandbox } from './secrets'
...
export async function processPaymentHandler(request: CallableRequest<ProcessPaymentRequest>) {
